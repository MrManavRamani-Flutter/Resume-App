...
import 'package:resume/Screen/eduction.dart';
import 'package:resume/Screen/place_screen.dart';
import 'package:resume/Screen/resume.dart';
import 'package:resume/Screen/work_space.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/': (context) => Home_Page(),
        'place_screen': (context) => Place_Screen(),
        ...
        'refernces_page': (context) => Refernces_Page(),
